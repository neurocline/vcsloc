...
// Windows console information/control
...
func TerminalWidth() int {
	...
	r1, r2, err := procGetConsoleScreenBufferInfo.Call(uintptr(windows.Stderr), uintptr(unsafe.Pointer(&info)))
	if r1 == 0 {
		log.Fatalf("Unexpected: %d, %d, %s", r1, r2, err)
